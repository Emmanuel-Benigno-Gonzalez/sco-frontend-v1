...
export default function CapForm({ register, errors, setValue } : OpsFormProps) {
    /*const handleSalidaSubmit = (e: React.FormEvent) => {
          e.preventDefault();
      }*/
  return (
    <>
      <div className="card llegadas" >
        ...
        <div>
          ...
          <button className="btn-guardar">Registrar Llegada</button>
        </div>
      </div>
